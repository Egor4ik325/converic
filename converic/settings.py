"""
Django settings for converic project.
...
SECRET_KEY = str(getenv('SECRET_KEY', get_random_secret_key()))
...
WSGI_APPLICATION = 'converic.wsgi.application'
